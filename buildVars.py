...
i18nSources = pythonSources + ["buildVars.py", "addon/appModules/edico/__init__.py", "addon/appModules/edico/edicoProfileSetup.py", "addon/appModules/edico/edicoObj.py", "addon/installTasks.py"]
